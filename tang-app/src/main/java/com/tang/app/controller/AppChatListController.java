...
public class AppChatListController {
    ...
    private final AppChatListService appChatListService;

    public AppChatListController(AppChatListService appChatListService) {
        this.appChatListService = appChatListService;
    }
    ...
    @GetMapping("/list")
    public TableDataResult list(AppChatList appChatList){
        PageUtils.startPage();
        var list = appChatListService.selectAppChatListList(appChatList);
    ...
    public AjaxResult listAll() {
        var list = appChatListService.selectAppChatListListAll();
    ...
    public AjaxResult selectAppChatListByChatListId(@PathVariable Long chatListId) {
    ...
    @PostMapping
    public AjaxResult add(@RequestBody AppChatList appChatList) {
    ...
    @PutMapping
    public AjaxResult edit(@RequestBody AppChatList appChatList) {
    ...
    public AjaxResult delete(@PathVariable Long chatListId) {
    ...
    @PreAuthorize("@auth.hasPermission('app:chat:chat-list:delete')")
    @DeleteMapping
    public AjaxResult deletes(@RequestBody Long[] chatListIds) {
