...
insert into sys_user values (1, 4, 'admin', '糖猫猫', 'admin@163.com', '16888888888', '0', '', '$2a$10$YTdSegecHZdVevRVbPpZAen3Mi91f0kejx642jwGIsYkOmQpxNpi.', '0', '0', '0', '127.0.0.1', null, 'admin', sysdate(), '', null, '超级管理员');
insert into sys_user values (2, 4, 'tang',  '糖糖',   'tang@163.com',  '16888888888', '0', '', '$2a$10$YTdSegecHZdVevRVbPpZAen3Mi91f0kejx642jwGIsYkOmQpxNpi.', '0', '0', '0', '127.0.0.1', null, 'admin', sysdate(), '', null, '普通用户');
insert into sys_user values (3, 4, 'miao',  '猫猫',   'miao@163.com',  '16888888888', '0', '', '$2a$10$YTdSegecHZdVevRVbPpZAen3Mi91f0kejx642jwGIsYkOmQpxNpi.', '0', '0', '0', '127.0.0.1', null, 'admin', sysdate(), '', null, '普通用户');
insert into sys_user values (4, 6, 'james',  'James Gosling', 'james-gosling@gmail.com',  '16888888888', '0', '', '$2a$10$YTdSegecHZdVevRVbPpZAen3Mi91f0kejx642jwGIsYkOmQpxNpi.', '0', '0', '0', '127.0.0.1', null, 'admin', sysdate(), '', null, '普通用户');
insert into sys_user values (5, 6, 'linus',  'Linus Torvalds', 'linus-torvalds@gmail.com',  '16888888888', '0', '', '$2a$10$YTdSegecHZdVevRVbPpZAen3Mi91f0kejx642jwGIsYkOmQpxNpi.', '0', '0', '0', '127.0.0.1', null, 'admin', sysdate(), '', null, '普通用户');
