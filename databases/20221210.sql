...
insert into sys_menu values (3, 0, '0', '系统监控', 'monitor',  '', '', '系统监控', 'D', '0', 3, '0', '0', 'admin', sysdate(), '', null, '系统监控目录');
insert into sys_menu values (4, 0, '0', '系统工具', 'tool',  '', '', '系统工具', 'D', '0', 4, '0', '0', 'admin', sysdate(), '', null, '系统工具目录');
insert into sys_menu values (5, 0, '0', '猫猫APP', 'app',  '', '', '猫猫APP', 'D', '0', 5, '0', '0', 'admin', sysdate(), '', null, '猫猫APP目录');
insert into sys_menu values (6, 1, '0,1', '用户管理', 'user', 'system/user/index', 'system:user:menu', '用户管理', 'M', '0', 1, '0', '0', 'admin', sysdate(), '', null, '用户管理菜单');
insert into sys_menu values (7, 1, '0,1', '部门管理', 'dept', 'system/dept/index', 'system:dept:menu', '部门管理', 'M', '0', 2, '0', '0', 'admin', sysdate(), '', null, '部门管理菜单');
insert into sys_menu values (8, 1, '0,1', '角色管理', 'role', 'system/role/index', 'system:role:menu', '角色管理', 'M', '0', 3, '0', '0', 'admin', sysdate(), '', null, '角色管理菜单');
insert into sys_menu values (9, 1, '0,1', '菜单管理', 'menu', 'system/menu/index', 'system:menu:menu', '菜单管理', 'M', '0', 4, '0', '0', 'admin', sysdate(), '', null, '菜单管理菜单');
insert into sys_menu values (10, 1, '0,1', '字典管理', 'dict', 'system/dict/index', 'system:dict:menu', '字典管理', 'M', '0', 5, '0', '0', 'admin', sysdate(), '', null, '字典管理菜单');
insert into sys_menu values (11, 1, '0,1', '日志管理', 'log',  '', '', '日志管理', 'D', '0', 6, '0', '0', 'admin', sysdate(), '', null, '日志管理菜单');
insert into sys_menu values (41, 3, '0,3', '在线用户', 'online', 'monitor/online/index', 'monitor:online:menu', '在线用户', 'M', '0', 1, '0', '0', 'admin', sysdate(), '', null, '在线用户菜单');
insert into sys_menu values (42, 3, '0,3', '服务监控', 'server', 'monitor/server/index', 'monitor:server:menu', '服务监控', 'M', '0', 2, '0', '0', 'admin', sysdate(), '', null, '服务监控菜单');
insert into sys_menu values (46, 4, '0,4', '代码生成', 'generator', 'tool/generator/index', 'tool:generator:menu', '代码生成', 'M', '0', 1, '0', '0', 'admin', sysdate(), '', null, '代码生成菜单');
insert into sys_menu values (47, 4, '0,4', '系统接口', 'swagger', 'tool/swagger/index', 'tool:swagger:menu', '系统接口', 'M', '0', 2, '0', '0', 'admin', sysdate(), '', null, '系统接口菜单');
insert into sys_menu values (56, 5, '0,5', '猫猫聊天', 'chat',  '', '', '猫猫聊天', 'D', '0', 1, '0', '0', 'admin', sysdate(), '', null, '猫猫聊天目录');
insert into sys_menu values (12, 6, '0,1,6', '用户查询', '', '', 'system:user:list', '', 'B', '0', 1, '0', '0', 'admin', sysdate(), '', null, '用户查询按钮');
insert into sys_menu values (13, 6, '0,1,6', '用户新增', '', '', 'system:user:add', '', 'B', '0', 2, '0', '0', 'admin', sysdate(), '', null, '用户新增按钮');
insert into sys_menu values (14, 6, '0,1,6', '用户修改', '', '', 'system:user:edit', '', 'B', '0', 3, '0', '0', 'admin', sysdate(), '', null, '用户修改按钮');
insert into sys_menu values (15, 6, '0,1,6', '用户删除', '', '', 'system:user:delete', '', 'B', '0', 4, '0', '0', 'admin', sysdate(), '', null, '用户删除按钮');
insert into sys_menu values (16, 7, '0,1,7', '部门查询', '', '', 'system:dept:list', '', 'B', '0', 1, '0', '0', 'admin', sysdate(), '', null, '部门查询按钮');
insert into sys_menu values (17, 7, '0,1,7', '部门新增', '', '', 'system:dept:add', '', 'B', '0', 2, '0', '0', 'admin', sysdate(), '', null, '部门新增按钮');
insert into sys_menu values (18, 7, '0,1,7', '部门修改', '', '', 'system:dept:edit', '', 'B', '0', 3, '0', '0', 'admin', sysdate(), '', null, '部门修改按钮');
insert into sys_menu values (19, 7, '0,1,7', '部门删除', '', '', 'system:dept:delete', '', 'B', '0', 4, '0', '0', 'admin', sysdate(), '', null, '部门删除按钮');
insert into sys_menu values (20, 8, '0,1,8', '角色查询', '', '', 'system:role:list', '', 'B', '0', 1, '0', '0', 'admin', sysdate(), '', null, '角色查询按钮');
insert into sys_menu values (21, 8, '0,1,8', '角色新增', '', '', 'system:role:add', '', 'B', '0', 2, '0', '0', 'admin', sysdate(), '', null, '角色新增按钮');
insert into sys_menu values (22, 8, '0,1,8', '角色修改', '', '', 'system:role:edit', '', 'B', '0', 3, '0', '0', 'admin', sysdate(), '', null, '角色修改按钮');
insert into sys_menu values (23, 8, '0,1,8', '角色删除', '', '', 'system:role:delete', '', 'B', '0', 4, '0', '0', 'admin', sysdate(), '', null, '角色删除按钮');
insert into sys_menu values (24, 9, '0,1,9', '菜单查询', '', '', 'system:menu:list', '', 'B', '0', 1, '0', '0', 'admin', sysdate(), '', null, '菜单查询按钮');
insert into sys_menu values (25, 9, '0,1,9', '菜单新增', '', '', 'system:menu:add', '', 'B', '0', 2, '0', '0', 'admin', sysdate(), '', null, '菜单新增按钮');
insert into sys_menu values (26, 9, '0,1,9', '菜单修改', '', '', 'system:menu:edit', '', 'B', '0', 3, '0', '0', 'admin', sysdate(), '', null, '菜单修改按钮');
insert into sys_menu values (27, 9, '0,1,9', '菜单删除', '', '', 'system:menu:delete', '', 'B', '0', 4, '0', '0', 'admin', sysdate(), '', null, '菜单删除按钮');
insert into sys_menu values (28, 10, '0,1,10', '字典查询', '', '', 'system:dict:list', '', 'B', '0', 1, '0', '0', 'admin', sysdate(), '', null, '字典查询按钮');
insert into sys_menu values (29, 10, '0,1,10', '字典新增', '', '', 'system:dict:add', '', 'B', '0', 2, '0', '0', 'admin', sysdate(), '', null, '字典新增按钮');
insert into sys_menu values (30, 10, '0,1,10', '字典修改', '', '', 'system:dict:edit', '', 'B', '0', 3, '0', '0', 'admin', sysdate(), '', null, '字典修改按钮');
insert into sys_menu values (31, 10, '0,1,10', '字典删除', '', '', 'system:dict:delete', '', 'B', '0', 4, '0', '0', 'admin', sysdate(), '', null, '字典删除按钮');
insert into sys_menu values (32, 11, '0,1,11', '登陆日志', 'login', 'system/log/login/index', 'system:log:login:menu', '登陆日志', 'M', '0', 1, '0', '0', 'admin', sysdate(), '', null, '登陆日志菜单');
insert into sys_menu values (33, 11, '0,1,11', '接口日志', 'api',  '', '', '接口日志', 'D', '0', 2, '0', '0', 'admin', sysdate(), '', null, '接口日志菜单');
insert into sys_menu values (43, 41, '0,3,41', '在线用户查询', '', '', 'monitor:online:list', '', 'B', '0', 1, '0', '0', 'admin', sysdate(), '', null, '在线用户查询按钮');
insert into sys_menu values (44, 41, '0,3,41', '在线用户删除', '', '', 'monitor:online:delete', '', 'B', '0', 2, '0', '0', 'admin', sysdate(), '', null, '在线用户删除按钮');
insert into sys_menu values (45, 42, '0,3,42', '服务监控查询', '', '', 'monitor:server:list', '', 'B', '0', 1, '0', '0', 'admin', sysdate(), '', null, '服务监控查询按钮');
insert into sys_menu values (48, 46, '0,4,46', '代码生成查询', '', '', 'tool:generator:list', '', 'B', '0', 1, '0', '0', 'admin', sysdate(), '', null, '代码生成查询按钮');
insert into sys_menu values (49, 46, '0,4,46', '代码生成修改', '', '', 'tool:generator:edit', '', 'B', '0', 2, '0', '0', 'admin', sysdate(), '', null, '代码生成修改按钮');
insert into sys_menu values (50, 46, '0,4,46', '代码生成删除', '', '', 'tool:generator:delete', '', 'B', '0', 3, '0', '0', 'admin', sysdate(), '', null, '代码生成删除按钮');
insert into sys_menu values (51, 46, '0,4,46', '代码生成导入', '', '', 'tool:generator:import', '', 'B', '0', 4, '0', '0', 'admin', sysdate(), '', null, '代码生成导入按钮');
insert into sys_menu values (52, 46, '0,4,46', '代码生成导出', '', '', 'tool:generator:export', '', 'B', '0', 5, '0', '0', 'admin', sysdate(), '', null, '代码生成导出按钮');
insert into sys_menu values (53, 46, '0,4,46', '代码生成执行', '', '', 'tool:generator:execute', '', 'B', '0', 6, '0', '0', 'admin', sysdate(), '', null, '代码生成执行按钮');
insert into sys_menu values (54, 46, '0,4,46', '代码生成同步', '', '', 'tool:generator:sync', '', 'B', '0', 7, '0', '0', 'admin', sysdate(), '', null, '代码生成同步按钮');
insert into sys_menu values (55, 47, '0,4,47', '系统接口查询', '', '', 'tool:swagger:list', '', 'B', '0', 1, '0', '0', 'admin', sysdate(), '', null, '系统接口查询按钮');
insert into sys_menu values (57, 56, '0,5,56', '我的聊天', 'room', 'app/chat/room/index', 'app:chat:room:menu', '我的聊天', 'M', '0', 1, '0', '0', 'admin', sysdate(), '', null, '猫猫聊天目录');
insert into sys_menu values (58, 56, '0,5,56', '好友申请', 'apply', 'app/chat/friend-apply/index', 'app:chat:friend-apply:menu', '好友申请', 'M', '0', 2, '0', '0', 'admin', sysdate(), '', null, '好友申请目录');
insert into sys_menu values (59, 56, '0,5,56', '我的好友', 'friend', 'app/chat/friend/index', 'app:chat:friend:menu', '我的好友', 'M', '0', 3, '0', '0', 'admin', sysdate(), '', null, '我的好友目录');
insert into sys_menu values (34, 32, '0,1,11,32', '登陆日志查询', '', '', 'system:log:login:list', '', 'B', '0', 1, '0', '0', 'admin', sysdate(), '', null, '登陆日志查询按钮');
insert into sys_menu values (35, 32, '0,1,11,32', '登陆日志删除', '', '', 'system:log:login:delete', '', 'B', '0', 2, '0', '0', 'admin', sysdate(), '', null, '登陆日志删除按钮');
insert into sys_menu values (36, 33, '0,1,11,33', '数据列表', 'data', 'system/log/api/data/index', 'system:log:api:data:menu', '数据列表', 'M', '0', 1, '0', '0', 'admin', sysdate(), '', null, '接口日志查询菜单');
insert into sys_menu values (37, 33, '0,1,11,33', '分析列表', 'analysis', 'system/log/api/analysis/index', 'system:log:api:analysis:menu', '分析列表', 'M', '0', 2, '0', '0', 'admin', sysdate(), '', null, '接口日志分析菜单');
insert into sys_menu values (60, 57, '0,5,56,57', '聊天列表查询', '', '', 'app:chat:chat-list:list', '', 'B', '0', 1, '0', '0', 'admin', sysdate(), '', null, '聊天列表查询按钮');
insert into sys_menu values (61, 57, '0,5,56,57', '聊天列表新增', '', '', 'app:chat:chat-list:add', '', 'B', '0', 2, '0', '0', 'admin', sysdate(), '', null, '聊天列表新增按钮');
insert into sys_menu values (62, 57, '0,5,56,57', '聊天列表修改', '', '', 'app:chat:chat-list:edit', '', 'B', '0', 3, '0', '0', 'admin', sysdate(), '', null, '聊天列表修改按钮');
insert into sys_menu values (63, 57, '0,5,56,57', '聊天列表删除', '', '', 'app:chat:chat-list:delete', '', 'B', '0', 4, '0', '0', 'admin', sysdate(), '', null, '聊天列表删除按钮');
insert into sys_menu values (64, 57, '0,5,56,57', '聊天消息查询', '', '', 'app:chat:message:list', '', 'B', '0', 5, '0', '0', 'admin', sysdate(), '', null, '聊天消息查询按钮');
insert into sys_menu values (65, 57, '0,5,56,57', '聊天消息新增', '', '', 'app:chat:message:add', '', 'B', '0', 6, '0', '0', 'admin', sysdate(), '', null, '聊天消息新增按钮');
insert into sys_menu values (66, 57, '0,5,56,57', '聊天消息修改', '', '', 'app:chat:message:edit', '', 'B', '0', 7, '0', '0', 'admin', sysdate(), '', null, '聊天消息修改按钮');
insert into sys_menu values (67, 57, '0,5,56,57', '聊天消息删除', '', '', 'app:chat:message:delete', '', 'B', '0', 8, '0', '0', 'admin', sysdate(), '', null, '聊天消息删除按钮');
insert into sys_menu values (68, 58, '0,5,56,58', '好友申请查询', '', '', 'app:chat:friend-apply:list', '', 'B', '0', 1, '0', '0', 'admin', sysdate(), '', null, '好友申请查询按钮');
insert into sys_menu values (69, 58, '0,5,56,58', '好友申请新增', '', '', 'app:chat:friend-apply:add', '', 'B', '0', 2, '0', '0', 'admin', sysdate(), '', null, '好友申请新增按钮');
insert into sys_menu values (70, 58, '0,5,56,58', '好友申请修改', '', '', 'app:chat:friend-apply:edit', '', 'B', '0', 3, '0', '0', 'admin', sysdate(), '', null, '好友申请修改按钮');
insert into sys_menu values (71, 58, '0,5,56,58', '好友申请同意', '', '', 'app:chat:friend-apply:accept', '', 'B', '0', 4, '0', '0', 'admin', sysdate(), '', null, '好友申请同意按钮');
insert into sys_menu values (72, 58, '0,5,56,58', '好友申请拒绝', '', '', 'app:chat:friend-apply:decline', '', 'B', '0', 5, '0', '0', 'admin', sysdate(), '', null, '好友申请拒绝按钮');
insert into sys_menu values (73, 58, '0,5,56,58', '好友申请删除', '', '', 'app:chat:friend-apply:delete', '', 'B', '0', 6, '0', '0', 'admin', sysdate(), '', null, '好友申请删除按钮');
insert into sys_menu values (74, 59, '0,5,56,59', '我的好友查询', '', '', 'app:chat:friend:list', '', 'B', '0', 1, '0', '0', 'admin', sysdate(), '', null, '我的好友查询按钮');
insert into sys_menu values (75, 59, '0,5,56,59', '我的好友新增', '', '', 'app:chat:friend:add', '', 'B', '0', 2, '0', '0', 'admin', sysdate(), '', null, '我的好友新增按钮');
insert into sys_menu values (76, 59, '0,5,56,59', '我的好友修改', '', '', 'app:chat:friend:edit', '', 'B', '0', 3, '0', '0', 'admin', sysdate(), '', null, '我的好友修改按钮');
insert into sys_menu values (77, 59, '0,5,56,59', '我的好友删除', '', '', 'app:chat:friend:delete', '', 'B', '0', 4, '0', '0', 'admin', sysdate(), '', null, '我的好友删除按钮');
insert into sys_menu values (38, 36, '0,1,11,33,36', '接口日志查询', '', '', 'system:log:api:data:list', '', 'B', '0', 1, '0', '0', 'admin', sysdate(), '', null, '接口日志查询按钮');
insert into sys_menu values (39, 36, '0,1,11,33,36', '接口日志删除', '', '', 'system:log:api:data:delete', '', 'B', '0', 2, '0', '0', 'admin', sysdate(), '', null, '接口日志删除按钮');
insert into sys_menu values (40, 37, '0,1,11,33,37', '接口日志分析', '', '', 'system:log:api:analysis:list', '', 'B', '0', 1, '0', '0', 'admin', sysdate(), '', null, '接口日志分析按钮');
