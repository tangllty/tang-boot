    ...
    private fun generateMenuList(): List<Menu> {
        val menuTree = arrayListOf(
            ...
            Menu("系统监控", "monitor", "系统监控", "系统监控目录", arrayListOf(
                ...
                Menu("Druid 监控", "druid", "monitor/druid/index", "monitor:druid:menu", "druid", "Druid 监控菜单", arrayListOf()),
                Menu("SBA 监控", "sba", "monitor/sba/index", "monitor:sba:menu", "sba", "SBA 监控菜单", arrayListOf()),
            )),
